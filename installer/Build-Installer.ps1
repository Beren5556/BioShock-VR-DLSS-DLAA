...
$outputPath = Join-Path $repoRoot 'artifacts\release\Instalador BioShock VR DLSS-DLAA Beta 0.2.6.exe'
$temporaryDirectory = Join-Path $sourceRoot ('.installer-build-' + [Guid]::NewGuid().ToString('N'))
$temporaryPath = Join-Path $temporaryDirectory 'Instalador BioShock VR DLSS-DLAA Beta 0.2.6.exe'
...
$resources = @(
    ...
    [pscustomobject]@{ Path = (Join-Path $payloadRoot 'bioshockvr.dll'); Name = 'bioshockvr.dll'; Hash = '781BF9095B2F0D807820D0C6945D327D93835AB447C7D431B9A93A7AFF652ACE' },
    ...
    [pscustomobject]@{ Path = (Join-Path $payloadRoot 'Lanzador BioShock VR DLSS-DLAA.exe'); Name = 'Lanzador BioShock VR DLSS-DLAA.exe'; Hash = '214CE0BFEC8A5CF364A98095D7E35CC951F5DAD9DBCD5B6B0DDB686AFA402A11' },
    [pscustomobject]@{ Path = (Join-Path $releaseDocsRoot 'LEEME-DLSS45.md'); Name = 'LEEME-DLSS45.md'; Hash = '64A8C61F23DC706B1B6F6B6530451198E92D1D574D318B8330901573FC761666' },
    ...
    [pscustomobject]@{ Path = (Join-Path $releaseDocsRoot 'INFORMACION-DEL-PAQUETE.txt'); Name = 'INFORMACION-DEL-PAQUETE.txt'; Hash = '2A8C6C77FE34DF9C278266073DEED2F36677BB984E738D05FA665A9DD5CD8F16' },
    [pscustomobject]@{ Path = (Join-Path $releaseDocsRoot 'dlss.ini.example'); Name = 'dlss.ini.example'; Hash = 'DE2825C895948FCBD58A3082802B0B50C1D99EEFA06A34FB513FC6E5F5E33009' },
